...
public class Homepage {
    ...
    public static By dest_list=By.className("sc-iwsKbI");
    public static  By calender_container= By.className("dPBSOp");

    public static By month_txt= By.xpath("//div[@class='DayNavigator__IconBlock-qj8jdz-2 iZpveD'][2]");

    public static By next_button=By.xpath("//div[@class='DayNavigator__IconBlock-qj8jdz-2 iZpveD'][3]");
